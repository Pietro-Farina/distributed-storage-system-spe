...
public class Main_MultipleRuns {
    ...
    public static void main(String[] args) throws Exception {
        ...
        long[] seeds = {
            7871902179783496417L,
            -6461786654312605547L,
            -3579375937319500055L,
            -199976726269248277L,
            -5842699577639093268L,
            2797742441533821272L,
            -5023332358052723603L,
            2365431599927628045L,
            6639888330179847177L,
            1491681940296414390L
        };


        String runId = cfg.log.runID + "Run";

        int i = 1;
        for  (long seed : seeds) {
            cfg.random.setSeed(seed);
            cfg.log.setRunID(runId + i);
            i++;
            ...
            var meta = new LogModels.Metadata(
                    ...
                    cfg.log.runID,      // not used; kept for completeness
                    loggerCfg.runTag,
            ...
            System.out.println("Logger baseDir: " + loggerCfg.baseDir.toAbsolutePath());
            System.out.println("Logger runDir:  " + AsyncRunLogger.get().runDir().toAbsolutePath());
            ...
            logger.close();   // ← THIS ends the lifecycle
